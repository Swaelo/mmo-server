...
using ContentLoader;
using ContentRenderer.Background;
using ContentRenderer.UI;
using ContentRenderer.PostProcessing;
using SharpDX.Direct3D11;
using SharpDX.DXGI;
using System;
using ContentRenderer.ShapeDrawing;
...
namespace ContentRenderer
{
    public class Renderer : IDisposable
    {
        ...
        public Renderer(RenderSurface surface)
        {
            ...
            Surface = surface;
            using (var stream = GetType().Assembly.GetManifestResourceStream("ContentRenderer.ContentRenderer.shaderarchive"))
            {
