...
namespace Server.GameItems
{
    ...
    {
        //List of every item currently available in the game, sorted by their item number value
        public static Dictionary<int, ItemData> MasterItemList = new Dictionary<int, ItemData>();

        //Loads all the items and their information into the dictionary from the text file
