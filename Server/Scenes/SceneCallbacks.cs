...
namespace Server.Scenes
{
    public struct ScenePoseIntegratorCallbacks : IPoseIntegratorCallbacks
    {
        ...
        public ScenePoseIntegratorCallbacks(Vector3 gravity, float linearDamping = .03f, float angularDamping = .03f) : this()
        {
            Gravity = gravity;
    ...
    public unsafe struct SceneNarrowPhaseCallbacks : INarrowPhaseCallbacks
    {
